...
- **SCAFFOLD** performed best in **highly heterogeneous data settings**, effectively reducing **client drift**
- **FedAdam** showed **fast initial convergence** but experienced **instability on noisier datasets**
